 ...
 * @property {String} fileSize optional, default value: `0`
 * @property {String} fileDownloadUrl optional
...
export const ProductVariant = new SimpleSchema({
  ...
  isDigital: {
    label: "Indicates if a product is digital or not",
    type: Boolean,
    defaultValue: false
  },
  fileSize: {
    label: "The file size if the product is digital",
    type: Number,
    defaultValue: 0,
    optional: true
  },
  fileDownloadUrl: {
    label: "Download link of product if the product is digital",
    type: String,
    optional: true
  },
  isLowQuantity: {
