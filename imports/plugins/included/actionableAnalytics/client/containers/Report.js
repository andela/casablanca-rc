...
export class Report extends React.Component {
  ...
  componentDidMount() {
    ...
    this.getAnalytics(self.state.fromDate, self.state.toDate);
    // Meteor.call("getProductInventoryOnMount",
    //   {
    ...
    //     });
    //   });
    Meteor.call("getProductInventoryDataOnMount", function (err, data) {
      if (!err) {
        console.log("===PRODUCTS===", data);
        self.setState({
          productInventoryData: data
        });
      }
    });
  }
 ...
 */
  ...
  handleShowInventoryReport = () => {
    this.setState({
      headingText: "Data and Inventory",
      selectedTab: "tab3"
    });
  }
  /**
 ...
 */
  handleShowProductStats = () => {
    this.setState({
      headingText: "Product Performance",
      selectedTab: "tab4"
    });
  }
  /**
  ...
  render() {
    ...
    return (
      <div className="container-fluid side-bar">
        ...
        />
        <div className="row">
          <div className="centered col-sm-4 col-md-4 col-md-offset-1 col-lg-4 col-lg-offset-1">
          ...
          />
          <div className="col-sm-8 col-md-8 col-md-offset-1 col-lg-8 col-lg-offset-1">
            <h3 className="header-text text-center">{this.state.headingText}</h3>
          </div>
        </div>
